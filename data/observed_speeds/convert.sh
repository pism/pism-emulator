...
for GRID in 1800; do
    ...
    cdo expr,"velsurf_mag=sqrt(vx^2+vy^2); velsurf_mag_error=sqrt(ex^2+ey^2);" -merge greenland_vel_mosaic250_*_v1_g${GRID}m.nc greenland_vel_mosaic250_v1_legacy_g${GRID}m.nc
done
